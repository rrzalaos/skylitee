...
export function NotConnected({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center bg-white dark:bg-[#171717] border border-black/[0.06] dark:border-white/[0.06] rounded-2xl">
      ...
      <h3 className="text-[16px] font-semibold text-[#18181B] dark:text-[#F4F4F5] mb-1.5">{label} not connected</h3>
      <p className="text-[15px] text-[#71717A] dark:text-[#A1A1AA] mb-6 max-w-xs leading-relaxed px-4">
        {description ?? `Connect ${label} to unlock real campaign data, performance metrics, and AI-powered recommendations.`}
      </p>
      <Link href="/dashboard/connections">
        <button className="px-5 py-2.5 bg-[#F97316] text-white rounded-xl text-[15px] font-semibold hover:bg-[#EA580C] transition-colors">
          Go to Connections
        </button>
      </Link>
    </div>
