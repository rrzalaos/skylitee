    ...
    <>
      ...
      <section className="bg-[#0A0A0A] text-white py-24 px-4 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto">
          <div className="text-[11px] font-bold uppercase tracking-[0.12em] text-[#F97316] mb-3">Our story</div>
          ...
          <p className="text-[16px] text-[#A1A1AA] leading-relaxed max-w-xl">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-3xl mx-auto">
          <div className="prose prose-lg max-w-none">
            <div className="space-y-6 text-[15px] text-[#52525B] leading-relaxed">
              <p>
              ...
              <div className="rounded-2xl bg-[#FFF7ED] border border-[#FED7AA] p-6 my-8">
                <div className="text-[13px] font-bold text-[#EA580C] mb-2 uppercase tracking-wider">Our mission</div>
                <p className="text-[15px] text-[#92400E] font-medium leading-relaxed m-0">
      ...
      <section className="py-16 px-4 bg-[#F5F5F4]">
        <div className="max-w-3xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            <div key={s.label} className="rounded-2xl bg-white border border-black/[0.06] p-5 text-center">
              <div className="text-[28px] font-black text-[#F97316] mb-1">{s.value}</div>
              <div className="text-[11px] font-bold text-[#71717A] uppercase tracking-[0.08em]">{s.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-[11px] font-bold uppercase tracking-[0.12em] text-[#F97316] mb-2">How we build</div>
            <h2 className="text-[32px] font-black text-[#18181B]">What we believe in</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {values.map(v => (
              <div key={v.title} className="rounded-2xl border border-black/[0.06] bg-white p-6 hover:border-[#F97316]/20 hover:shadow-md transition-all">
                <div className="w-10 h-10 rounded-xl bg-[#FFF7ED] flex items-center justify-center mb-4">
                  <v.icon size={18} className="text-[#F97316]" />
                </div>
                <div className="text-[15px] font-bold text-[#18181B] mb-2">{v.title}</div>
                <p className="text-[13px] text-[#71717A] leading-relaxed">{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-[#0A0A0A] text-white">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-[11px] font-bold uppercase tracking-[0.12em] text-[#F97316] mb-2">How we got here</div>
            <h2 className="text-[32px] font-black">The Skylitee timeline</h2>
          </div>
          <div className="space-y-0">
            {timeline.map((t, i) => (
              <div key={t.year} className="flex gap-6 group">
                <div className="flex flex-col items-center">
                  <div className="w-10 h-10 rounded-xl bg-[#F97316]/10 border border-[#F97316]/30 flex items-center justify-center shrink-0 group-hover:bg-[#F97316]/20 transition-colors">
                    <span className="text-[#F97316] font-black text-[10px] text-center leading-tight">{t.year.replace(" ", "\n")}</span>
                  </div>
                  {i < timeline.length - 1 && (
                ...
                <div className="pb-8">
                  <div className="text-[13px] font-bold text-[#F97316] mb-1">{t.year}</div>
                  <p className="text-[14px] text-[#71717A] leading-relaxed">{t.event}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 px-4 bg-white text-center">
        <div className="max-w-xl mx-auto">
          <h2 className="text-[32px] font-black text-[#18181B] mb-4">Try Skylitee free for 14 days</h2>
          <p className="text-[15px] text-[#71717A] mb-8">No credit card. No setup fees. Just connect your store and see your data.</p>
          <Link href="/install"
            className="inline-block px-8 py-4 bg-[#F97316] hover:bg-[#EA580C] text-white font-bold rounded-xl text-[15px] transition-all shadow-[0_0_24px_rgba(249,115,22,0.3)] hover:shadow-[0_0_36px_rgba(249,115,22,0.5)]">
            Install on Shopify →
          </Link>
          <div className="mt-6">
            <Link href="/contact" className="text-[13px] text-[#71717A] hover:text-[#F97316] transition-colors">
