      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center gap-2.5 mb-8">
          ...
          <div>
            ...
            <div className="text-[14px] text-[#9e9e9a]">Unified Analytics for D2C Brands</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-black/[0.09] p-6 shadow-sm">
          ...
          <p className="text-[15px] text-[#686864] mb-5">
            Skylitee will read your orders, products, and customer data to power your analytics dashboard.
          </p>

          {hasError && (
            <div className="bg-[#fce8e8] border border-[#f5a0a0] rounded-lg px-3 py-2.5 mb-4 text-[15px] text-[#6e1c1c]">
              Connection failed. Please try again.
            </div>
          )}

          <div className="mb-4">
            <label className="text-[15px] font-medium text-[#181816] block mb-1.5">
            ...
            <input
              ...
              className="w-full px-3 py-2.5 border border-black/[0.15] rounded-lg text-[16px] text-[#181816] bg-white focus:outline-none focus:border-[#17a773] transition-colors"
          ...
          <div className="mt-5 pt-4 border-t border-black/[0.07]">
            <div className="text-[14px] font-semibold text-[#9e9e9a] uppercase tracking-wider mb-2.5">What Skylitee will access</div>
            {[
              ...
              <div key={i} className="flex items-center gap-2 mb-1.5">
                ...
                <span className="text-[15px] text-[#686864]">{item}</span>
              </div>
            ))}
          </div>
        </div>

        <p className="text-center text-[14px] text-[#9e9e9a] mt-4">
