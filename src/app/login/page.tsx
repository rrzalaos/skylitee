      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center justify-center gap-2.5 mb-8">
          ...
          <div>
            ...
            <div className="text-[13px] text-[#9e9e9a]">Unified Analytics Platform</div>
          </div>
        </div>
        ...
        <div className="bg-white border border-black/[0.09] rounded-2xl p-7 shadow-sm">
          ...
          <p className="text-[14px] text-[#686864] mb-6">Sign in to your analytics dashboard</p>

          <form onSubmit={handleLogin} className="space-y-3">
            <div>
              <label className="text-[14px] font-medium text-[#686864] mb-1 block">Email</label>
              <input
                type="email" value={email} onChange={e => setEmail(e.target.value)}
                placeholder="demo@fabonique.com"
                className="w-full px-3 py-2.5 bg-[#f7f7f5] border border-black/[0.09] rounded-lg text-[15px] text-[#181816] focus:outline-none focus:border-[#17a773] placeholder:text-[#9e9e9a]"
                required
              />
            </div>
            <div>
              <label className="text-[14px] font-medium text-[#686864] mb-1 block">Password</label>
            ...
            {error && (
              <div className="text-[13px] text-[#d94040] bg-[#fce8e8] px-2.5 py-2 rounded-lg border border-[#f5a0a0]">
                {error}
              </div>
            )}
            ...
            <button
              ...
              className="w-full py-2.5 bg-[#17a773] text-white rounded-lg text-[15px] font-semibold hover:bg-[#0d6b4f] transition-colors disabled:opacity-60 mt-1"
            >
          ...
          <div className="mt-5 pt-4 border-t border-black/[0.06] text-center">
            <div className="text-[13px] text-[#9e9e9a] mb-1.5">Demo credentials</div>
            <div className="text-[14px] font-medium text-[#686864]">demo@fabonique.com</div>
            <div className="text-[14px] font-medium text-[#686864]">Skylitee</div>
          </div>
        </div>
