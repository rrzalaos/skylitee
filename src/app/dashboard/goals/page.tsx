...
function GoalBar({ label, current, target, currentLabel, targetLabel, color, note }: {
  ...
  return (
    <div className="mb-3">
      ...
      <div className="flex justify-between text-[10px] mt-1 text-[#686864]">
        <span>{pct}%</span>
    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-2">
        <Card>
          ...
          <div className="mb-3">
            <label className="text-[10px] text-[#686864] mb-1 block">Gross Sales Target (₹)</label>
            <input
              type="number" value={salesTarget}
              onChange={e => setSalesTarget(Number(e.target.value))}
              className="w-full px-2.5 py-2 bg-[#f7f7f5] rounded-lg text-[13px] font-semibold border border-black/[0.09] focus:outline-none focus:border-[#17a773]"
            />
          </div>
          <div className="mb-3">
            <label className="text-[10px] text-[#686864] mb-1 block">Target ROAS</label>
            <input
          ...
          <div className="mb-4">
            <label className="text-[10px] text-[#686864] mb-1 block">Target AOV (₹)</label>
            <input
          ...
          <div className="flex gap-2">
            <button className="flex-1 py-2 border border-black/[0.16] rounded-lg text-[11px] text-[#181816] hover:bg-[#f7f7f5] transition-colors">
              Reset
            </button>
            <button
              onClick={handleUpdate}
              className="flex-[2] py-2 bg-[#17a773] text-white rounded-lg text-[11px] font-semibold hover:bg-[#0d6b4f] transition-colors"
            >
              Update & Generate
            </button>
          </div>
          {toast && (
            <div className="mt-2 text-[10px] text-[#064d38] bg-[#e0f5ee] rounded-lg px-2.5 py-1.5">
