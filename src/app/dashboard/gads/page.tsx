    ...
    <div>
      ...
      <div className="flex items-start justify-between mb-3">
        <div>
          ...
          <p className="text-[12px] text-[#686864] mt-0.5">AI-recommended campaign plan · based on your GSC data</p>
        </div>
      </div>
              ...
              <tbody>
                {plannedCampaigns.map((c, i) => (
                  <tr key={i} className="border-b border-black/[0.06] last:border-0 hover:bg-[#f7f7f5]">
                    ...
                    <td className="py-1.5 px-1.5 text-[10px] text-[#686864]">{c.keywords}</td>
          ...
          {gscKeywords.map((k, i) => (
            <div key={i} className="flex items-center justify-between py-2 border-b border-black/[0.06] last:border-0">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] text-[#686864]">{k.clicks} clicks</span>
              </div>
            </div>
          ))}
